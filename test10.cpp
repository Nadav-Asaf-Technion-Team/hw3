...
void TEST10() {
    ...
    to<<p17<<endl;
    Participant p18("kazakhastan","song_kazakhastan",123,"singer_kazakhastan");
    to<<p18<<endl;
    ...
    to<<p28<<endl;
    Participant p29("netherlands","song_netherlands",180,"singer_netherlands");
    to<<p29<<endl;
    ...
    eurovision+=Vote(v89,"belarus","sweden","spain","luxembourg","israel");
    ...
    eurovision+=Vote(v9,"bosnia");
    eurovision+=Vote(v84,"hungary");
    eurovision+=Vote(v71,"lithiania");
    ...
    eurovision+=Vote(v89,"malta","switzerland","russia","lithiania","turkey","sweden","bosnia");
    ...
    eurovision+=Vote(v29,"italy","greece","norway","serbia","luxembourg","moldova","turkey");
    ...
    eurovision+=Vote(v61,"switzerland","andora","ukraine","slovenia","malta");
    eurovision+=Vote(v23,"bosnia");
    eurovision+=Vote(v38,"moldova");
    eurovision+=Vote(v40,"croatia","andora","greece","sweden","germany","austria","ukraine","france","russia","luxembourg");
    eurovision+=Vote(v20,"norway");
    eurovision+=Vote(v64,"estonia");
    eurovision+=Vote(v92,"spain");
    eurovision+=Vote(v50,"austria","turkey","italy","ireland","estonia","germany","croatia");
    eurovision+=Vote(v68,"netherlands");
    eurovision+=Vote(v95,"lithiania","spain","netherlands","belarus","germany","russia","moldova","croatia");
    eurovision+=Vote(v14,"malta");
    eurovision+=Vote(v97,"belarus");
    eurovision+=Vote(v79,"armenia");
    eurovision+=Vote(v56,"israel","andora","hungary","slovenia","latvia","cyrpus","ukraine","ireland","spain");
    eurovision+=Vote(v77,"russia");
    eurovision+=Vote(v53,"moldova");
    eurovision+=Vote(v18,"slovenia","kazakhastan","italy","bulgaria","norway","lithiania","spain","germany","croatia");
    ...
    eurovision+=Vote(v8,"italy","slovenia","kazakhastan","bosnia","malta","croatia","luxembourg","switzerland");
    ...
    eurovision+=Vote(v19,"cyrpus","serbia","andora","kazakhastan","lithiania","sweden","belgium");
    eurovision+=Vote(v63,"turkey");
    eurovision+=Vote(v44,"ireland","estonia","belarus","hungary","armenia","malta");
    ...
    eurovision+=Vote(v83,"switzerland","spain","sweden","bosnia","serbia","turkey","malta","netherlands","belgium");
    eurovision+=Vote(v15,"kazakhastan");
    eurovision+=Vote(v73,"switzerland");
    eurovision+=Vote(v62,"malta","belarus","greece","moldova","switzerland","netherlands","hungary","ukraine");
    eurovision+=Vote(v62,"hungary","ireland","malta","russia","bulgaria","croatia","slovakia","serbia","ukraine");
    ...
    eurovision+=Vote(v69,"spain","sweden","austria","belgium","ukraine","slovakia","georgia","slovenia","netherlands");
    ...
    eurovision+=Vote(v82,"latvia","georgia","germany","armenia","turkey","luxembourg");
    ...
    eurovision+=Vote(v19,"croatia","slovenia","georgia","israel","luxembourg","bulgaria","greece","belarus","ukraine");
    eurovision+=Vote(v47,"belgium");
    eurovision+=Vote(v32,"germany");
    eurovision+=Vote(v8,"georgia","lithiania","germany","moldova","norway","greece","hungary","israel");
    ...
    eurovision+=Vote(v56,"switzerland","serbia","israel","slovenia","latvia","estonia");
    ...
    eurovision+=Vote(v10,"spain","greece","italy","ukraine","france","cyrpus","bosnia","kazakhastan","slovakia","bulgaria");
    ...
    eurovision+=Vote(v39,"israel","spain","bulgaria","cyrpus","slovakia");
    eurovision+=Vote(v28,"cyrpus");
    eurovision+=Vote(v34,"serbia");
    eurovision+=Vote(v52,"estonia");
    eurovision+=Vote(v73,"ireland");
    eurovision+=Vote(v85,"moldova","serbia","greece","armenia","switzerland","cyrpus");
    eurovision+=Vote(v62,"luxembourg","france");
    eurovision+=Vote(v93,"italy","belgium","ireland","luxembourg","lithiania");
    ...
    eurovision+=Vote(v18,"malta","netherlands","bulgaria","luxembourg","bosnia","greece","georgia","moldova");
    eurovision+=Vote(v52,"hungary");
    eurovision+=Vote(v52,"georgia");
    eurovision+=Vote(v75,"ukraine");
    eurovision+=Vote(v8,"russia","greece","germany","france","italy","estonia","netherlands","lithiania");
    eurovision+=Vote(v59,"norway","netherlands","moldova","turkey","bulgaria","ukraine","sweden","slovakia","georgia");
    eurovision+=Vote(v10,"cyrpus","russia","luxembourg","germany","moldova","netherlands","andora");
    ...
    eurovision+=Vote(v48,"bosnia");
    eurovision+=Vote(v10,"bosnia","netherlands","georgia","bulgaria","france","sweden","israel","estonia");
